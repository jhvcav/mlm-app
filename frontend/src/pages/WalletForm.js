...
const WalletForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (response.ok) {
            ...
            setWalletData({ walletName: '', publicAddress: '', encryptedPassword: '', secretPhrase: '' });
        } else {
    ...
    return (
        <div className="form-container">
            ...
            <form onSubmit={handleSubmit} className="wallet-form">
                ...
                <input type="text" name="secretPhrase" placeholder="Phrase secrète (optionnel)" value={walletData.secretPhrase} onChange={handleChange} className="secret-input" />
